...
Esta sección solo sirve a modo de explicación de como estan estructuradas las carpetas de esta practica. En el directorio raiz se encuentran 5 carpetas, 3 de ellas correspondientes a los ejemplos, otra denominada ``Parte 2'', destinada al ejercicio del servidor de donaciones, y una última con las implementaciones anteriores de la segunda parte.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{ClienteMainVarios.java: }Versión que pone a prueba la sincronización del servidores realizando múltiples registros consecutivos.
