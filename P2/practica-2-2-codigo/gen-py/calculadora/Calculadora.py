...
class Client(Iface):
    ...
    def biseccion(self, ecuacion, error, inf, sup):
        ...
        """
        self.send_biseccion(ecuacion, error, inf, sup)
        return self.recv_biseccion()

    def send_biseccion(self, ecuacion, error, inf, sup):
        self._oprot.writeMessageBegin('biseccion', TMessageType.CALL, self._seqid)
        args = biseccion_args()
        args.ecuacion = ecuacion
        args.error = error
        args.inf = inf
        args.sup = sup
        args.write(self._oprot)
    ...
    def recv_biseccion(self):
        ...
        if mtype == TMessageType.EXCEPTION:
            ...
            iprot.readMessageEnd()
            raise x
        result = biseccion_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "biseccion failed: unknown result")
...
class Processor(Iface, TProcessor):
    ...
    def process_biseccion(self, seqid, iprot, oprot):
        args = biseccion_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = biseccion_result()
        try:
            result.success = self._handler.biseccion(args.ecuacion, args.error, args.inf, args.sup)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("biseccion", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class biseccion_args(object):
    ...
    def __init__(self, ecuacion=None, error=None, inf=None, sup=None,):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.ecuacion = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.DOUBLE:
                    self.error = iprot.readDouble()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.DOUBLE:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('biseccion_args')
        if self.ecuacion is not None:
            oprot.writeFieldBegin('ecuacion', TType.STRING, 1)
            oprot.writeString(self.ecuacion.encode('utf-8') if sys.version_info[0] == 2 else self.ecuacion)
            oprot.writeFieldEnd()
        if self.error is not None:
            oprot.writeFieldBegin('error', TType.DOUBLE, 2)
            oprot.writeDouble(self.error)
            oprot.writeFieldEnd()
        if self.inf is not None:
            oprot.writeFieldBegin('inf', TType.DOUBLE, 3)
            oprot.writeDouble(self.inf)
            oprot.writeFieldEnd()
        if self.sup is not None:
            oprot.writeFieldBegin('sup', TType.DOUBLE, 4)
            oprot.writeDouble(self.sup)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(biseccion_args)
biseccion_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'ecuacion', 'UTF8', None, ),  # 1
    (2, TType.DOUBLE, 'error', None, None, ),  # 2
    (3, TType.DOUBLE, 'inf', None, None, ),  # 3
    (4, TType.DOUBLE, 'sup', None, None, ),  # 4
)


class biseccion_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('biseccion_result')
        if self.success is not None:
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(biseccion_result)
biseccion_result.thrift_spec = (
